  ...
  return (
    <Box className="flex justify-between items-center">
      <Box className="flex-col items-center p-2">
        ...
        <Typography sx={{ fontSize: '1em', fontWeight: 700, color: 'black' }}>
          Goal
        </Typography>
      </Box>

      <Box >
        <Typography sx={{ fontSize: '1.5em', fontWeight: 700, color: 'black' }}>
          -
        </Typography>
      </Box>
      ...
      <Box >
        <Typography sx={{ fontSize: '1.2em', fontWeight: 700, color: 'black' }}>
          +
        </Typography>
      </Box>
      ...
      {calGoal >= consumedTotal - summary.exercise ? (
        ...
        <Box className="flex flex-col items-center p-2">
          <Typography sx={{ fontSize: '1em', fontWeight: 700 }} color={'error'}>
